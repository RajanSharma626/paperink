                    ...
                    <div class="editor-card w-100">
                        ...
                        <div class="editor-header mb-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="editor-tip mt-2 mt-lg-0">A well-written cover letter increases your chances
                                    of getting noticed!</span>
                            </div>
                        </div>
                        <!-- Form -->
                        <form @submit.prevent="handleNext">
                            <div class="row">
                                <template v-if="step === 1">
                                    ...
                                    <div class="col-6 mb-3">
                                        ...
                                        <input class="form-custom" type="text"
                                            v-model="coverStore.coverData.jobTitle" />
                                    </div>
                                    <div class="col-6 mb-3">
                            ...
                            <div class="d-flex justify-content-between mt-4 gap-3">
                                ...
                                <button v-else type="button" @click="saveCoverLetter"
                                    class="btn theme-btn btn-lg flex-grow-1">
                                    Save Cover Letter
                                </button>
                            </div>
                        </form>
...
const saveCoverLetter = async () => {
    try {
        const result = await coverStore.saveCoverLetter(coverStore.coverData, templateId)
        if (result.success) {
            // Redirect to cover letter view page (adjust route as needed)
            router.replace(`/cover-letter/${result.coverLetterId}/view`)
        } else {
            alert(result.message || 'Failed to save cover letter.')
        }
    } catch (error) {
